...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.twitter_user'
        db.alter_column(u'core_user', 'twitter_user', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'User.facebook_user'
        db.alter_column(u'core_user', 'facebook_user', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'User.twitter_id'
        db.alter_column(u'core_user', 'twitter_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'User.facebook_id'
        db.alter_column(u'core_user', 'facebook_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.twitter_token'
        db.alter_column(u'core_user', 'twitter_token', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'User.twitter_user'
        db.alter_column(u'core_user', 'twitter_user', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'User.facebook_user'
        db.alter_column(u'core_user', 'facebook_user', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'User.twitter_id'
        db.alter_column(u'core_user', 'twitter_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'User.facebook_id'
        db.alter_column(u'core_user', 'facebook_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'User.facebook_token'
        db.alter_column(u'core_user', 'facebook_token', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        u'core.user': {
            ...
            'facebook_token': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'twitter_token': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
