...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.publish'
        db.add_column(u'core_media', 'publish',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Publish']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.publish'
        db.delete_column(u'core_media', 'publish_id')
    ...
    models = {
        u'core.media': {
            ...
            'publish': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['core.Publish']"})
        },
        u'core.publish': {
