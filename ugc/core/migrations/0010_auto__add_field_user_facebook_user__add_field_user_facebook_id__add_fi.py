...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.facebook_user'
        db.add_column(u'core_user', 'facebook_user',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'User.facebook_id'
        db.add_column(u'core_user', 'facebook_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'User.facebook_token'
        db.add_column(u'core_user', 'facebook_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.facebook_user'
        db.delete_column(u'core_user', 'facebook_user')

        # Deleting field 'User.facebook_id'
        db.delete_column(u'core_user', 'facebook_id')

        # Deleting field 'User.facebook_token'
        db.delete_column(u'core_user', 'facebook_token')
